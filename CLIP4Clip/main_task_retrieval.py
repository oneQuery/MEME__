...
def _run_on_single_gpu(
    ...
    batch_sequence_output_list_coarse,
    batch_visual_output_list,
    batch_visual_output_list_coarse,
    batch_visual_output_list_multi,
    batch_visual_output_list_multi_coarse,
):
    sim_matrix = []
    for idx1, b1 in enumerate(batch_list_t):
        ...
        for idx2, b2 in enumerate(batch_list_v):
            ...
            b1b2_logits, *_tmp = model.get_similarity_logits(
                sequence_output,
                sequence_output_coarse,
                visual_output,
                visual_output_coarse,
                visual_output_multi,
                visual_output_multi_coarse,
                input_mask,
                video_mask,
...
def eval_epoch(args, model, test_dataloader, device, n_gpu):
    ...
    with torch.no_grad():
        ...
        (
            ...
            batch_sequence_output_list_coarse,
            batch_visual_output_list,
            batch_visual_output_list_Corase,
        ) = ([], [], [], [])
        (
            batch_seq_output_multi_list,
            batch_seq_output_multi_list_coarse,
            batch_visual_output_multi_list,
        ...
        for bid, batch in enumerate(test_dataloader):
            ...
            if multi_sentence_:
                ...
                b, *_t = video.shape
                sequence_output, sequence_output_coarse = model.get_sequence_output(
                ...
                if len(filter_inds) > 0:
                    ...
                    (
                        ...
                        visual_output_multi,
                        visual_output_multi_coarse,
                    ) = model.get_visual_output(video, video_mask)
                    ...
                    batch_visual_output_list_multi_Corase.append(
                        visual_output_multi_coarse
                    )
        ...
        if n_gpu > 1:
            ...
            for dev_id in device_ids:
                ...
                if dev_id == 0:
                    ...
                    batch_t_output_splits_coarse.append(
                        batch_sequence_output_list_coarse[s_:e_]
                    )
                    ...
                    batch_v_output_splits_multi_coarse.append(
                        batch_visual_output_list_multi_Corase
                    )
                else:
                    ...
                    devc_batch_list = [
                        b.to(devc) for b in batch_sequence_output_list_coarse[s_:e_]
                    ]
                    batch_t_output_splits_coarse.append(devc_batch_list)
                    devc_batch_list = [b.to(devc) for b in batch_visual_output_list]
                    batch_v_output_splits.append(devc_batch_list)
                    devc_batch_list = [
                        b.to(devc) for b in batch_visual_output_list_Corase
                    ]
                    batch_v_output_splits_coarse.append(devc_batch_list)
                    devc_batch_list = [
                        b.to(devc) for b in batch_visual_output_multi_list
                    ]
                    batch_v_output_splits_multi.append(devc_batch_list)
                    devc_batch_list = [
                        b.to(devc) for b in batch_visual_output_list_multi_Corase
                    ]
            ...
            parameters_tuple_list = [
                (
                    ...
                    batch_t_output_splits_coarse[dev_id],
                    batch_v_output_splits[dev_id],
                    batch_v_output_splits_coarse[dev_id],
                    batch_v_output_splits_multi[dev_id],
                    batch_v_output_splits_multi_coarse[dev_id],
                )
                for dev_id in device_ids
            ]
